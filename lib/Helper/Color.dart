...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffFD9701);
  static const Color primary2 = Color(0xffEA1E63);
  static const Color primary1 = Color(0xff73B934);
  static const Color secondary = Color(0xffFD9701);
  static const Color secondary1 = Color(0xffFD9701);
  ...
  static const Color grad1Color = Color(0xffFD9701);
  static Color grad2Color = Color(0xff73B934).withOpacity(0.6);
